...
- **TC1: draw null card and give to player** ( x )
    - **State of the system**: drawPile has cards; player is valid; card is null
    - **Expected output**: throws IllegalArgumentException

- **TC1: draw one card from pile with one card** ( x )
...
- **TC1: draw one card from pile with many cards** ( x )
...
- **TC1: draw card from pile with many cards and give to player with existing hand** ( x )
